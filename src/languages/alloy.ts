...
export const alloy = {
  ...
  i18n: {
    en: {
      name: 'Alloy',
      description:
        'A relational modeling language with a SAT-based analyzer for finding design flaws.',
      longDescription:
    ...
    es: {
      name: 'Alloy',
      description:
        'Un lenguaje de modelado relacional con un analizador basado en SAT para hallar fallos de diseño.',
      longDescription:
    ...
    it: {
      name: 'Alloy',
      description:
        'Un linguaggio di modellazione relazionale con un analizzatore basato su SAT per trovare difetti di progetto.',
      longDescription:
    ...
    fr: {
      name: 'Alloy',
      description:
        'Un langage de modélisation relationnelle avec un analyseur SAT pour détecter les défauts de conception.',
      longDescription:
    ...
    de: {
      name: 'Alloy',
      description:
        'Eine relationale Modellierungssprache mit SAT-basiertem Analyzer zum Aufspüren von Designfehlern.',
      longDescription:
    ...
    pt: {
      name: 'Alloy',
      description:
        'Uma linguagem de modelagem relacional com analisador baseado em SAT para achar falhas de projeto.',
      longDescription:
