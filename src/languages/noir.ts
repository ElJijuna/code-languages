...
export const noir = {
  ...
  i18n: {
    ...
    fr: {
      name: 'Noir',
      description: 'Un langage proche de Rust pour écrire des circuits à divulgation nulle de connaissance.',
      longDescription:
    ...
    de: {
      name: 'Noir',
      description: 'Eine Rust-ähnliche Sprache zum Schreiben von Zero-Knowledge-Beweis-Schaltkreisen.',
      longDescription:
