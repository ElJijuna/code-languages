...
export const j = {
  ...
  i18n: {
    ...
    es: {
      name: 'J',
      description:
        'Un lenguaje de arrays conciso del creador de APL, usando ASCII en lugar de símbolos.',
      longDescription:
    ...
    it: {
      name: 'J',
      description:
        'Un linguaggio di array conciso del creatore di APL, con ASCII al posto dei simboli.',
      longDescription:
    ...
    fr: {
      name: 'J',
      description:
        "Un langage de tableaux concis du créateur d'APL, utilisant l'ASCII plutôt que des symboles.",
      longDescription:
    ...
    pt: {
      name: 'J',
      description:
        'Uma linguagem de arrays concisa do criador do APL, usando ASCII em vez de símbolos.',
      longDescription:
