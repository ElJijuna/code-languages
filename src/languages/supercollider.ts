...
export const supercollider = {
  ...
  i18n: {
    en: {
      name: 'SuperCollider',
      description:
        'A platform and language for real-time audio synthesis and algorithmic composition.',
      longDescription:
    ...
    es: {
      name: 'SuperCollider',
      description:
        'Una plataforma y lenguaje para síntesis de audio en tiempo real y composición algorítmica.',
      longDescription:
    ...
    it: {
      name: 'SuperCollider',
      description:
        'Una piattaforma e linguaggio per la sintesi audio in tempo reale e la composizione algoritmica.',
      longDescription:
    ...
    fr: {
      name: 'SuperCollider',
      description:
        'Une plateforme et un langage pour la synthèse audio temps réel et la composition algorithmique.',
      longDescription:
    ...
    de: {
      name: 'SuperCollider',
      description:
        'Eine Plattform und Sprache für Echtzeit-Audiosynthese und algorithmische Komposition.',
      longDescription:
    ...
    pt: {
      name: 'SuperCollider',
      description:
        'Uma plataforma e linguagem para síntese de áudio em tempo real e composição algorítmica.',
      longDescription:
