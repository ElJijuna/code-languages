...
export const flix = {
  ...
  i18n: {
    en: {
      name: 'Flix',
      description:
        'A JVM language combining functional, imperative, and Datalog-style logic programming.',
      longDescription:
    ...
    es: {
      name: 'Flix',
      description:
        'Un lenguaje JVM que combina programación funcional, imperativa y lógica estilo Datalog.',
      longDescription:
    ...
    it: {
      name: 'Flix',
      description:
        'Un linguaggio JVM che combina programmazione funzionale, imperativa e logica in stile Datalog.',
      longDescription:
    ...
    fr: {
      name: 'Flix',
      description:
        'Un langage JVM combinant programmation fonctionnelle, impérative et logique de type Datalog.',
      longDescription:
    ...
    de: {
      name: 'Flix',
      description:
        'Eine JVM-Sprache, die funktionale, imperative und Datalog-artige Logikprogrammierung vereint.',
      longDescription:
    ...
    pt: {
      name: 'Flix',
      description:
        'Uma linguagem JVM que combina programação funcional, imperativa e lógica estilo Datalog.',
      longDescription:
