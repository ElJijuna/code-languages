...
export const renpy = {
  ...
  i18n: {
    ...
    es: {
      name: "Ren'Py",
      description: 'Un motor de novelas visuales con un lenguaje de guion tipo cinematográfico que embebe Python.',
      longDescription:
    ...
    fr: {
      name: "Ren'Py",
      description: 'Un moteur de visual novels au langage de script façon scénario, avec Python intégré.',
      longDescription:
