...
export const faust = {
  ...
  i18n: {
    en: {
      name: 'Faust',
      description:
        'A functional language for real-time audio DSP that compiles to C++, WebAssembly, and more.',
      longDescription:
    ...
    es: {
      name: 'Faust',
      description:
        'Un lenguaje funcional para DSP de audio en tiempo real que compila a C++, WebAssembly y más.',
      longDescription:
    ...
    it: {
      name: 'Faust',
      description:
        'Un linguaggio funzionale per DSP audio in tempo reale che compila in C++, WebAssembly e altro.',
      longDescription:
    ...
    fr: {
      name: 'Faust',
      description:
        'Un langage fonctionnel pour le DSP audio temps réel, compilant vers C++, WebAssembly et plus.',
      longDescription:
    ...
    de: {
      name: 'Faust',
      description:
        'Eine funktionale Sprache für Echtzeit-Audio-DSP, die zu C++, WebAssembly und mehr kompiliert.',
      longDescription:
    ...
    pt: {
      name: 'Faust',
      description:
        'Uma linguagem funcional para DSP de áudio em tempo real que compila para C++, WebAssembly e mais.',
      longDescription:
