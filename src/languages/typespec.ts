...
export const typespec = {
  ...
  i18n: {
    en: {
      name: 'TypeSpec',
      description:
        'A TypeScript-inspired language from Microsoft for describing APIs, emitting OpenAPI and more.',
      longDescription:
    ...
    es: {
      name: 'TypeSpec',
      description:
        'Un lenguaje de Microsoft inspirado en TypeScript para describir APIs, emitiendo OpenAPI y más.',
      longDescription:
    ...
    it: {
      name: 'TypeSpec',
      description:
        'Un linguaggio Microsoft ispirato a TypeScript per descrivere API, generando OpenAPI e altro.',
      longDescription:
    ...
    fr: {
      name: 'TypeSpec',
      description:
        'Un langage Microsoft inspiré de TypeScript pour décrire des API, générant OpenAPI et plus.',
      longDescription:
    ...
    de: {
      name: 'TypeSpec',
      description:
        'Eine TypeScript-inspirierte Sprache von Microsoft zur API-Beschreibung, die OpenAPI und mehr erzeugt.',
      longDescription:
    ...
    pt: {
      name: 'TypeSpec',
      description:
        'Uma linguagem da Microsoft inspirada em TypeScript para descrever APIs, emitindo OpenAPI e mais.',
      longDescription:
