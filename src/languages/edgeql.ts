...
export const edgeql = {
  ...
  i18n: {
    en: {
      name: 'EdgeQL',
      description:
        'The composable query language of the Gel (formerly EdgeDB) graph-relational database.',
      longDescription:
    ...
    es: {
      name: 'EdgeQL',
      description:
        'El lenguaje de consultas componible de la base de datos grafo-relacional Gel (antes EdgeDB).',
      longDescription:
    ...
    it: {
      name: 'EdgeQL',
      description:
        'Il linguaggio di query componibile del database grafo-relazionale Gel (ex EdgeDB).',
      longDescription:
    ...
    fr: {
      name: 'EdgeQL',
      description:
        'Le langage de requête composable de la base graphe-relationnelle Gel (ex-EdgeDB).',
      longDescription:
    ...
    de: {
      name: 'EdgeQL',
      description:
        'Die komponierbare Abfragesprache der graph-relationalen Datenbank Gel (früher EdgeDB).',
      longDescription:
    ...
    pt: {
      name: 'EdgeQL',
      description:
        'A linguagem de consulta componível do banco grafo-relacional Gel (antes EdgeDB).',
      longDescription:
