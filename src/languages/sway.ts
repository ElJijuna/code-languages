...
export const sway = {
  ...
  i18n: {
    ...
    es: {
      name: 'Sway',
      description: 'Un lenguaje de contratos inteligentes inspirado en Rust para la máquina virtual de Fuel.',
      longDescription:
    ...
    de: {
      name: 'Sway',
      description: 'Eine Rust-inspirierte Smart-Contract-Sprache für die virtuelle Maschine von Fuel.',
      longDescription:
    ...
    pt: {
      name: 'Sway',
      description: 'Uma linguagem de contratos inteligentes inspirada em Rust para a máquina virtual da Fuel.',
      longDescription:
