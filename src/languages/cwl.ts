...
export const cwl = {
  ...
  i18n: {
    ...
    es: {
      name: 'Common Workflow Language',
      description: 'Un estándar abierto para describir flujos de análisis de datos portables y reproducibles.',
      longDescription:
    ...
    fr: {
      name: 'Common Workflow Language',
      description: "Un standard ouvert pour décrire des workflows d'analyse de données portables et reproductibles.",
      longDescription:
    ...
    pt: {
      name: 'Common Workflow Language',
      description: 'Um padrão aberto para descrever fluxos de análise de dados portáveis e reproduzíveis.',
      longDescription:
