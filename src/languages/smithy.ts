...
export const smithy = {
  ...
  i18n: {
    ...
    es: {
      name: 'Smithy',
      description: 'El lenguaje de definición de interfaces de AWS, agnóstico de protocolo, para modelar servicios.',
      longDescription:
    ...
    fr: {
      name: 'Smithy',
      description: "Le langage de définition d'interfaces d'AWS, indépendant du protocole, pour modéliser des services.",
      longDescription:
    ...
    de: {
      name: 'Smithy',
      description: 'AWS\' protokollunabhängige Schnittstellenbeschreibungssprache zur Modellierung von Services.',
      longDescription:
    ...
    pt: {
      name: 'Smithy',
      description: 'A linguagem de definição de interfaces da AWS, agnóstica de protocolo, para modelar serviços.',
      longDescription:
