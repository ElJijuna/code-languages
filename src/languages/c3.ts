...
export const c3 = {
  ...
  i18n: {
    en: {
      name: 'C3',
      description:
        'An evolution of C with modules, generics, and safety, keeping C ABI compatibility.',
      longDescription:
    ...
    es: {
      name: 'C3',
      description:
        'Una evolución de C con módulos, genéricos y seguridad, manteniendo compatibilidad ABI con C.',
      longDescription:
    ...
    it: {
      name: 'C3',
      description:
        "Un'evoluzione di C con moduli, generics e sicurezza, mantenendo la compatibilità ABI con C.",
      longDescription:
    ...
    de: {
      name: 'C3',
      description:
        'Eine Weiterentwicklung von C mit Modulen, Generics und Sicherheit, ABI-kompatibel zu C.',
      longDescription:
    ...
    pt: {
      name: 'C3',
      description:
        'Uma evolução do C com módulos, genéricos e segurança, mantendo compatibilidade ABI com C.',
      longDescription:
