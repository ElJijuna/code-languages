...
export const languageLoaders: Record<LanguageSlug, () => Promise<Language>> = {
  ...
  angelscript: () => import('./languages/angelscript').then((module) => module.angelscript),
  ...
  'avro-idl': () => import('./languages/avro-idl').then((module) => module.avroIdl),
  ...
  cel: () => import('./languages/cel').then((module) => module.cel),
  ...
  cql: () => import('./languages/cql').then((module) => module.cql),
  ...
  flatbuffers: () => import('./languages/flatbuffers').then((module) => module.flatbuffers),
  ...
  fql: () => import('./languages/fql').then((module) => module.fql),
  ...
  gml: () => import('./languages/gml').then((module) => module.gml),
  ...
  gremlin: () => import('./languages/gremlin').then((module) => module.gremlin),
  ...
  'ink-narrative': () => import('./languages/ink-narrative').then((module) => module.inkNarrative),
  ...
  jmespath: () => import('./languages/jmespath').then((module) => module.jmespath),
  json: () => import('./languages/json').then((module) => module.json),
  json5: () => import('./languages/json5').then((module) => module.json5),
  jsonata: () => import('./languages/jsonata').then((module) => module.jsonata),
  ...
  kql: () => import('./languages/kql').then((module) => module.kql),
  ...
  maxima: () => import('./languages/maxima').then((module) => module.maxima),
  ...
  modelica: () => import('./languages/modelica').then((module) => module.modelica),
  ...
  n1ql: () => import('./languages/n1ql').then((module) => module.n1ql),
  nextflow: () => import('./languages/nextflow').then((module) => module.nextflow),
  ...
  octave: () => import('./languages/octave').then((module) => module.octave),
  ...
  org: () => import('./languages/org').then((module) => module.org),
  ...
  plpgsql: () => import('./languages/plpgsql').then((module) => module.plpgsql),
  plsql: () => import('./languages/plsql').then((module) => module.plsql),
  pod: () => import('./languages/pod').then((module) => module.pod),
  ...
  snakemake: () => import('./languages/snakemake').then((module) => module.snakemake),
  snobol: () => import('./languages/snobol').then((module) => module.snobol),
  solidity: () => import('./languages/solidity').then((module) => module.solidity),
  soql: () => import('./languages/soql').then((module) => module.soql),
  sparql: () => import('./languages/sparql').then((module) => module.sparql),
  spark: () => import('./languages/spark').then((module) => module.spark),
  spl: () => import('./languages/spl').then((module) => module.spl),
  spss: () => import('./languages/spss').then((module) => module.spss),
  sql: () => import('./languages/sql').then((module) => module.sql),
  squirrel: () => import('./languages/squirrel').then((module) => module.squirrel),
  ...
  tcsh: () => import('./languages/tcsh').then((module) => module.tcsh),
  tex: () => import('./languages/tex').then((module) => module.tex),
  textile: () => import('./languages/textile').then((module) => module.textile),
  ...
  troff: () => import('./languages/troff').then((module) => module.troff),
  tsql: () => import('./languages/tsql').then((module) => module.tsql),
  twee: () => import('./languages/twee').then((module) => module.twee),
  ...
  velocity: () => import('./languages/velocity').then((module) => module.velocity),
  ...
  wdl: () => import('./languages/wdl').then((module) => module.wdl),
